...
public class ClientPageDTO {
   ...
   */
  public ClientPageDTO(List<ClientDTO> items, Integer page, Integer size, Long totalElements, Integer totalPages) {
    this.items = items;
    this.page = page;
    this.size = size;
  ...
  public ClientPageDTO items(List<ClientDTO> items) {
    this.items = items;
    return this;
  }
